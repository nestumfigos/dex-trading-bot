...
const { assessPaperEarlyBreakout } = require('../src/utils/paper-early-breakout');

test('kucoin early breakout qualifies on short-horizon strength with persistence', () => {
  const result = assessPaperEarlyBreakout({
    chainName: 'kucoin',
    ...
    settingsByChain: {
      kucoin: {
        ...
        minFeatureBars: 30,
        allowedCoverage: ['usable', 'good', 'excellent'],
      },
    },
  });
