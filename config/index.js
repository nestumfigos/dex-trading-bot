...
const config = {
  ...
  execution: {
    ...
    allowTechnicalFallbackOnAiFailure: process.env.ALLOW_TECHNICAL_FALLBACK_ON_AI_FAILURE === 'true',
    kucoinPendingAiAdvisory: process.env.KUCOIN_PENDING_AI_ADVISORY !== 'false',
    kucoinPendingAiMinConfirmations: parseIntEnv('KUCOIN_PENDING_AI_MIN_CONFIRMATIONS', 2),
