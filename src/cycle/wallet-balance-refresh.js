...
async function updateWalletBalance(ctx, logger) {
  ...
  try {
    ...
    // is 0 while wallet shows real funds. Happens when boot-time wallet fetch
    // returned 0 (RPC down) and seeded portfolio.balance=0, then wallet recovered.
    // Without this, drift sits at 100% forever and balanceDriftHalt blocks all trading.
