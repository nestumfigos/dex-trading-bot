...
// DexScreener public endpoints are ~100 req/min per IP. Without coordination, BSC + Base + Solana
// + Jupiter discovery can fire hundreds of concurrent requests during a scan cycle and silently
// 429. This client serializes calls, caches responses by URL, and trips a circuit breaker after
// repeated failures.
...
// 2026-05-23: dedupe circuit-open warn so flapping circuit doesn't write
...
async function throttledFetch(url, options = {}) {
  ...
  // Circuit breaker: return stale or null
  if (isCircuitOpen()) {
  ...
  // Serialize calls behind a global throttle
