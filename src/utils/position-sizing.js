...
class PositionSizingEngine {
   ...
   *
   * 2026-05-31 audit (cycle-2 P1): `|| 10000` defaults treated a $0 wallet
   * as $10k for drawdown / available-balance / min-size logic. A depleted
   * wallet did not look depleted to the risk engine, which would happily
   * size new entries against a phantom balance. Replaced with explicit
   * `Number.isFinite` guards so genuine zero balances stay zero. Mirrors
   * the paper-side fix at dex-trading-bot-paper/src/utils/position-sizing.js.
   */
