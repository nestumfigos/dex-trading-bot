...
const KNOBS = {
  ...
  SOLANA_BULL_FLAG_V2_MIN_NET_EDGE_PCT: { type: 'float', min: 0, default: 4, hotReload: true },
  SOLANA_BULL_FLAG_V2_MIN_RR: { type: 'float', min: 0, default: 2.2, hotReload: true },
  SOLANA_BULL_FLAG_V2_MAX_STOP_DISTANCE_PCT: { type: 'float', min: 0, default: 5, hotReload: true },
  SOLANA_BULL_FLAG_V2_MIN_60M_MOVE_PCT: { type: 'float', min: 0, default: 5, hotReload: true },
  SOLANA_BULL_FLAG_V2_MAX_60M_MOVE_PCT: { type: 'float', min: 0, default: 18, hotReload: true },
  SOLANA_BULL_FLAG_V2_VOLUME_LOOKBACK_CANDLES: { type: 'int', min: 1, default: 20, hotReload: true },
  SOLANA_BULL_FLAG_V2_LATEST_VOLUME_MIN_RATIO: { type: 'float', min: 0, default: 1.8, hotReload: true },
  SOLANA_BULL_FLAG_V2_MIN_FRESH_SOURCES: { type: 'int', min: 1, default: 2, hotReload: true },
  SOLANA_BULL_FLAG_V2_MAX_SOURCE_AGE_MS: { type: 'int', min: 1000, default: 120000, hotReload: true },
  SOLANA_BULL_FLAG_V2_MAX_TOP10_HOLDERS_PCT: { type: 'float', min: 0, max: 100, default: 30, hotReload: true },
  SOLANA_BULL_FLAG_V2_MAX_SLIPPAGE_PCT: { type: 'float', min: 0, default: 1.5, hotReload: true },
  SOLANA_BULL_FLAG_V2_MAX_PRICE_IMPACT_PCT: { type: 'float', min: 0, default: 1.8, hotReload: true },
  SOLANA_BULL_FLAG_V2_TIMEFRAMES: { type: 'string', default: '15m,5m', hotReload: true },
  ...
  BULL_FLAG_MAX_FLAG_UPWARD_DRIFT_PCT: { type: 'float', min: 0, default: 1, hotReload: true },
  ...
  BULL_FLAG_VOLUME_LOOKBACK_CANDLES: { type: 'int', min: 1, default: 20, hotReload: true },
  BULL_FLAG_LATEST_VOLUME_MIN_RATIO: { type: 'float', min: 0, default: 2, hotReload: true },
  BULL_FLAG_MIN_60M_MOVE_PCT: { type: 'float', min: 0, default: 5, hotReload: true },
  BULL_FLAG_MAX_60M_MOVE_PCT: { type: 'float', min: 0, default: 12, hotReload: true },
  BULL_FLAG_MIN_TARGET_REMAINING_PCT: { type: 'float', min: 0, max: 100, default: 20, hotReload: true },
  BULL_FLAG_TIMEFRAMES: { type: 'string', default: '15m,5m', hotReload: true },
  ...
  BULL_FLAG_EMA_SLOW_PERIOD: { type: 'int', min: 2, default: 21, hotReload: true },
  BULL_FLAG_EMA_TOLERANCE_PCT: { type: 'float', min: 0, default: 0.15, hotReload: true },
  ...
  BULL_FLAG_MIN_RR: { type: 'float', min: 0, default: 2, hotReload: true },
  BULL_FLAG_EXPECTED_FEES_BPS: { type: 'float', min: 0, default: 30, hotReload: true },
  BULL_FLAG_EXPECTED_SLIPPAGE_BPS: { type: 'float', min: 0, default: 20, hotReload: true },
  BULL_FLAG_MAX_ASK_BID_DEPTH_RATIO: { type: 'float', min: 1, default: 1.35, hotReload: true },
  BULL_FLAG_MIN_ORDERBOOK_DEPTH_IMBALANCE: { type: 'float', default: -0.15, hotReload: true },
  ...
  BULL_FLAG_MAX_DAILY_LOSS_R: { type: 'float', min: 0, default: 3, hotReload: true },
